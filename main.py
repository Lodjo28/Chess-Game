...
from tkinter import Tk, Button, Label, PhotoImage, StringVar, N, E, S, W
...
piece_images = {
    0: PhotoImage(file='PNG\\VideIntersideral.png'),
    1: PhotoImage(file='PNG\\PionNoir.png'),
    2: PhotoImage(file='PNG\\PionBlanc.png'),
    3: PhotoImage(file='PNG\\TourNoire.png'),
    4: PhotoImage(file='PNG\\TourBlanche.png'),
    5: PhotoImage(file='PNG\\ChevalierNoir.png'),
    6: PhotoImage(file='PNG\\ChevalierBlanc.png'),
    7: PhotoImage(file='PNG\\FouNoir.png'),
    8: PhotoImage(file='PNG\\FouBlanc.png'),
    9: PhotoImage(file='PNG\\ReineNoire.png'),
    10: PhotoImage(file='PNG\\ReineBlanche.png'),
    11: PhotoImage(file='PNG\\RoiNoir.png'),
    12: PhotoImage(file='PNG\\RoiBlanc.png')
}
